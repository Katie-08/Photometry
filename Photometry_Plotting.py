...
animal_folder = "RM5"
File_Name = "20240408_RM5_FC_Ch2"
ANYMAZEprotocol = 'RFM_Photometry'
DayForAnalysis = 'RFM_FC_US'
pre_tag = 30
post_tag = 40
T_auc_stim_end = 40 # end time for calculating AUC after footshock (t=0)
...
Fig_Title = "CeA astrocyte activity"
output_dir = f"C:/Users/Kai-Yi.WANG/PycharmProjects/Photometry_analysis/Figure/{animal_folder}/"
